...
const AppHeader: React.FC = () => {
  ...
  // Check if we're in tutor portal
  const isTutorPortal = pathname?.startsWith('/tutor') || false;
  
  // Show attendance button only for admin portal (not tutor)
  const showAttendanceButton = useMemo(() => {
    return !isTutorPortal && (user?.role === 'super_admin' || user?.role === 'admin');
  }, [isTutorPortal, user?.role]);
      ...
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          ...
          <div className="hidden lg:block">
            ...
            >
              ...
              <span className="inline-flex items-center gap-0.5 rounded-md border border-gray-200 bg-gray-100 px-1.5 py-0.5 text-xs font-medium text-gray-500 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400">
                <span>⌘</span>
                <span>K</span>
              </span>
            </button>
        ...
        >
          <div className="flex items-center gap-2 2xsm:gap-3">
            ...
            {/* Attendance Button - Only show for admin portal */}
